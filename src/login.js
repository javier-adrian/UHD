var formatBlock = function () {
    return {
        message: '<svg aria-hidden=\"true\" role=\"status\" class=\"inline w-4 h-4 md:w-6 md:h-6 my-4 me-3 text-gray-200 animate-spin dark:text-gray-600\" viewBox=\"0 0 100 101\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">' +
            ...
            '</svg>' +
            '<span class="align-middle md:text-xl text-rose-950">Loading</span>',
        css: {
...
var onLogin = function () {
    $("#frmLogin").submit(function(e) {
        ...
        $.post('scripts/php/loginStudent.php', loginObj, function(data) {
            if (!data.isSuccess) {
                var msg = data.msg;
                var alert = '<div class="text-sm align-middle md:text-base bg-red-100 border border-red-400 text-red-700 mb-2 px-4 py-3 pt-3.5 md:pt-3 rounded relative" role="alert">' +
                    msg +
