...
var onLogin = function () {
    $("#frmLogin").submit(function(e) {
        ...
        $.post('scripts/php/loginStudent.php', loginObj, function(data) {
            if (!data.isSuccess) {
                var msg = data.msg;
                var alert = '<div class="text-sm align-middle md:text-base bg-red-100 border border-red-400 text-red-700 mb-4 px-4 py-3 pt-3.5 md:pt-3 rounded relative" role="alert">' +
                    msg +
