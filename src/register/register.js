var formatBlock = function () {
    return {
        message:
            '<svg aria-hidden=\"true\" role=\"status\" class=\"inline w-4 h-4 md:w-6 md:h-6 my-4 me-3 text-gray-200 animate-spin dark:text-gray-600\" viewBox=\"0 0 100 101\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">' +
